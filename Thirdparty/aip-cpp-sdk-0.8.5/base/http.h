...
public:
    ...
    void setConnectTimeout(int connect_timeout) { this->connect_timeout = connect_timeout; }

    void setUseHttp2(bool isUseHttp2) { isHttp2 = isUseHttp2; }

    void setSocketTimeout(int socket_timeout) { this->socket_timeout = socket_timeout; }

    void setDebug(bool debug) { this->debug = debug; }

    int get(std::string url, std::map<std::string, std::string> const* params,
            std::map<std::string, std::string> const* headers, std::string* response) const
    {
    ...
    int post(std::string url, std::map<std::string, std::string> const* params, const std::string& body,
             std::map<std::string, std::string> const* headers, std::string* response) const
    {
        struct curl_slist* slist = NULL;
        CURL* curl = curl_easy_init();
    ...
    int post(std::string url, std::map<std::string, std::string> const* params,
    ...
    int post(std::string url, std::map<std::string, std::string> const* params, Json::Value const& data,
             std::map<std::string, std::string> const* headers, std::string* response) const
    {
        std::string body;
